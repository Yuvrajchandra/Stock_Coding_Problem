...
response = res.json()
purchasedAt= int(response[2]["purchasedAt"])
...
CRM = yf.Ticker('CRM')
data=CRM.history(start="2019-06-06", end="2020-05-06",interval="1wk")
data2=CRM.history(start="2020-05-06", end="2020-06-06",interval="1wk")
...
plt.title("CRM: 06/06/2019-06/06/2020", fontsize=16)
plt.ylabel('Close')
plt.xlabel('Date')
