...
response = res.json()
purchasedAt= int(response[3]["purchasedAt"])
...
WORK = yf.Ticker('WORK')
data=WORK.history(start="2019-06-06", end="2020-05-06",interval="1wk")
data2=WORK.history(start="2020-05-06", end="2020-06-06",interval="1wk")
...
plt.title("WORK: 06/06/2019-06/06/2020", fontsize=16)
plt.ylabel('Close')
plt.xlabel('Date')
